...
For the detailed business meanings, descriptions, and data types of every column, refer to the product specification [03-DATABASE-SCHEMA.md](../03-DATABASE-SCHEMA.md).
