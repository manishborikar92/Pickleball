      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <div className="flex flex-col gap-4 sm:col-span-2 lg:col-span-2 lg:pr-8">
            ...
            {/* Social Handles & Community Links */}
            <div className="mt-3 flex flex-wrap items-center gap-2.5">
              <a
                href="https://instagram.com/baseline.arena"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 rounded-xl border border-line/60 bg-surface-panel/40 px-3 py-1.5 text-xs font-semibold text-muted transition-all hover:border-accent/40 hover:bg-accent/10 hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                aria-label="Follow us on Instagram"
              >
                <InstagramIcon className="h-4 w-4 shrink-0 text-muted transition-colors group-hover:text-accent" />
                <span>@baseline.arena</span>
              </a>

              <a
                href="https://chat.whatsapp.com/E6JLSpiejoY11xoC3bNUEo"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 rounded-xl border border-line/60 bg-surface-panel/40 px-3 py-1.5 text-xs font-semibold text-muted transition-all hover:border-accent/40 hover:bg-accent/10 hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                aria-label="Join our WhatsApp Community"
              >
                <WhatsAppIcon className="h-4 w-4 shrink-0 text-muted transition-colors group-hover:text-accent" />
