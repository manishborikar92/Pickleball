...
import { sendOtpSchema, adminLoginSchema, verifyOtpSchema } from './auth.validators.js';
...
export const createAuthRouter = ({ authService, userService } = {}) => {
  ...
  router.post('/admin/login', authLimiter, validate(adminLoginSchema), controller.loginAdmin);
